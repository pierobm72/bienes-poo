document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".mobile-menu"),n=document.querySelector(".navegacion");e.addEventListener("click",e=>{n.classList.toggle("mostrar")})})
